...
int main() {
    ...
    const string   testString = auxString + auxString + auxString +
        auxString;
    const MyString testMyString = auxMyString + auxMyString + auxMyString +
        auxMyString;
    cout << boolalpha;
    ...
    cout << testString.substr(20, 10) << " " << testMyString.substr(20, 10) << endl
        << endl;
    ...
    cout << (testString.rfind('a', 60) == testMyString.rfind('a', 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind('0', 60) == testMyString.rfind('0', 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind('8', 60) == testMyString.rfind('8', 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind('9', 60) == testMyString.rfind('9', 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind("018", 60) == testMyString.rfind("018", 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind("648", 60) == testMyString.rfind("648", 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind("012", 60) == testMyString.rfind("012", 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind("890", 60) == testMyString.rfind("890", 60)) << endl <<
        endl;
    ...
    cout << (testString.rfind("789", 60) == testMyString.rfind("789", 60)) << endl <<
        endl;
    ...
    cout << (emptyString.rfind('0', 20) == emptyMyString.rfind('0', 20)) << endl <<
        endl;
    ...
    cout << (emptyString.rfind("", 0) == emptyMyString.rfind("", 0)) << endl;
    cout << (emptyString.rfind("", 20) == emptyMyString.rfind("", 20)) << endl <<
        endl;
    ...
    cout << (testString2.find("00001") == testMyString2.find("00001")) << endl <<
        endl;
